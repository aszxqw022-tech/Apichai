...
('ผัดไทยกุ้งสด', 'เส้นจันท์เหนียวนุ่ม ผัดกับน้ำซอสมะขามเปียกสูตรโบราณเข้มข้น และกุ้งสดตัวโต', 89.00, 'main', 'https://images.unsplash.com/photo-1626804475315-86445582f3ef?w=600&auto=format&fit=crop&q=80'),
...
('ข้าวเหนียวมะม่วง', 'ข้าวเหนียวมูนกะทิหอมหวานมัน เสิร์ฟพร้อมมะม่วงน้ำดอกไม้สุกสีทองหวานฉ่ำ โรยถั่วทองกรุบกรอบ', 99.00, 'dessert', 'https://images.unsplash.com/photo-1608755673199-a6ab1cfdb59e?w=600&auto=format&fit=crop&q=80'),
